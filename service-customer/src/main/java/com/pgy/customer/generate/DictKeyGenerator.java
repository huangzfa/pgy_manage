...
public class DictKeyGenerator {
	...
	public static void main(String[] args) throws SQLException {
		...
		try {
			...
			Template temp = cfg.getTemplate("/service-manage/src/main/resources/generate/ZD.ftl");

			/* Create a data-model */
			Map<String, List<DictVo>> root = new HashMap<String, List<DictVo>>();
			root.put("dctList", dctList);

			File f = new File("D:\\javaweb\\pgy-manage\\service-common\\src\\main\\java\\com\\pgy\\common\\dic\\ZD.java");
